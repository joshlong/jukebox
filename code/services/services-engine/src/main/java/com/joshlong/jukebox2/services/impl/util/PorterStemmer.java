...
public class PorterStemmer {
    ...
    static private class NewString {
        public String str;
    ...
    public static void main(String[] args) throws Throwable {
        ...
        for (String word : "cows, cheese,cheeses,geese, men, mice, cars, fucking dicks heads, fatheads, moo".split(
                ",")) {
            System.out.println(word + ":" + stemmer.stripAffixes(word.trim()));
        }
    }
    ...
    private boolean cvc(String str) {
        ...
        if ((!vowel(str.charAt(length - 1), str.charAt(length - 2))) && (str.charAt(length - 1) != 'w') && (str.charAt(
                length - 1) != 'x') && (str.charAt(length - 1) != 'y')
            ...
            if ((hasSuffix(str, "ed", stem)) || (hasSuffix(str, "ing", stem))) {
                if (containsVowel(stem.str)) {
                    ...
                    if ((hasSuffix(str, "at", stem)) || (hasSuffix(str, "bl", stem)) || (hasSuffix(str, "iz", stem))) {
                        ...
                        int length = str.length();
                        if ((str.charAt(length - 1) == str.charAt(length - 2)) && (str.charAt(
                                length - 1) != 'l') && (str.charAt(length - 1) != 's') && (str.charAt(
                                length - 1) != 'z')) {
