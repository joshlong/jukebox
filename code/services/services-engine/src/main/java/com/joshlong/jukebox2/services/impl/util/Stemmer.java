...
/**
 * Stemmer, implementing the Porter Stemming Algorithm The Stemmer class transforms a word into its root form. The input
 * word can be provided a character at time (by calling add()), or at once by calling one of the various stem(something)
 * methods.
 */
public class Stemmer {
    ...
    public static void main(String[] args) {
        ...
        for (String word : "cows, cheeses, cheese,geese, men, mice, cars, fucking dicks heads, fatheads, moo".split(
                ",")) {
